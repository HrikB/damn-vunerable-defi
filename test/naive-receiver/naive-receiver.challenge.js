...
describe("[Challenge] Naive receiver", function () {
  ...
  let pool, receiver, drainReceiver;
  ...
  before(async function () {
    ...
    const DrainReceiverFactory = await ethers.getContractFactory(
      "DrainReceiver"
    );
    drainReceiver = await DrainReceiverFactory.deploy(
      pool.address,
      receiver.address
    );
  });
