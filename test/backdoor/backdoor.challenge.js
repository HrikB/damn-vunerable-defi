...
describe("[Challenge] Backdoor", function () {
  ...
  it("Execution", async function () {
    const backdoorAttackFactory = await ethers.getContractFactory(
      "BackdoorAttack",
      deployer
    );
    const backdoorAttack = await backdoorAttackFactory.deploy(
    ...
    await backdoorAttack.connect(player).pwn();
  });
